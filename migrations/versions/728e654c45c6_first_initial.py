...
Revision ID: 728e654c45c6
Revises: 
Create Date: 2025-06-26 20:22:40.549463
...
def upgrade() -> None:
    ...
    sa.Column('number', sa.Enum('first', 'second', 'third', 'fourth', 'fifth', 'sixth', 'seventh', name='numbertable'), nullable=False),
